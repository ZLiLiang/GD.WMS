        ...
        <div class="container" ref="container">
            <div class="form-container sign-up-container">
                <el-form ref="loginRef">
                    ...
                    <el-form-item>
                        <el-input auto-complete="off" placeholder="验证码" style="width: 65%" />
                        <div class="login-code">
                            <el-image class="login-code-img" />
                        </div>
                    </el-form-item>
                    <el-form-item style="margin-top:20px">
                        <el-button size="default" round type="primary" style="width: 90%">
                            注册
                        </el-button>
                    </el-form-item>
                </el-form>
            ...
            <div class="form-container sign-in-container">
                <el-form ref="registerRef">
                    ...
                    <el-form-item style="margin-top:20px">
                        <el-button size="default" round type="primary">
                            登录
                        </el-button>
                    </el-form-item>
                </el-form>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    <div class="overlay-panel overlay-left">
                        <h1>欢迎回来!</h1>
                        <p>为了您的账户安全，请使用您的个人信息登录！</p>
                        <el-button class="ghost" @click="loginPage">登 录</el-button>
                    </div>
                    <div class="overlay-panel overlay-right">
                        <h1>您好！</h1>
                        <p>输入您的信息并与我们一起开始愉快的旅程</p>
                        <el-button class="ghost" @click="registerPage">注 册</el-button>
                    </div>
                </div>
            </div>
        </div>
